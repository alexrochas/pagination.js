...
/***/ function(module, exports, __webpack_require__) {
	...
	window.Pagination = function (element, pages, perPage) {
	  return new _pagination2.default(element, pages, perPage);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tinyEmitter = __webpack_require__(39);
	...
	var Pagination = function (_Emitter) {
	  _inherits(Pagination, _Emitter);

	  function Pagination(element, data) {
	    var perPage = arguments.length <= 2 || arguments[2] === undefined ? 1 : arguments[2];

	    _classCallCheck(this, Pagination);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Pagination).call(this));

	    _initialiseProps.call(_this);

	    _this.setData(data, perPage);
	    _this.goToPage(1);
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.setData = function (data) {
	    ...
	    _this2.setPerPage(perPage);
	    _this2.pages = _utils2.default.split(data, _this2.perPage);

	    return _this2;
	  };

	  this.setPerPage = function (perPage) {
	    _this2.perPage = perPage;
	  ...
	  this.hasPage = function (page) {
	    return page > 0 && page < _this2.size();
	  };
	  ...
	  this.previousPage = function (callback) {
	    _this2.goToPage(_this2.page - 1, callback);
	  };

	  this.currentPage = function () {
	    return _this2.getPage(_this2.page);
	  };
...
/***/ function(module, exports) {
	...
	exports.default = {
	  'split': function split(list, offset) {
	    var lists = [];
	    var partialList = [];
	    var page = 1;
	    var i = 1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Template = function Template(onNextPage, onClickPage, onPreviousPage) {
	  var _this = this;

	  _classCallCheck(this, Template);

	  this.renderPage = function (page, onClick, className) {
	    var disabled = arguments.length <= 3 || arguments[3] === undefined ? false : arguments[3];

	    return (0, _h2.default)('li', {
	      'className': className
	    }, (0, _h2.default)('button', {
	      disabled: disabled,
	      'onclick': onClick
	    }, page));
	  };

	  this.renderPages = function (pages) {
	    var currentPage = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];

	    var defaultClassName = 'pagination__pages__page';

	    return pages.map(function (content, page) {
	      var className = currentPage == page ? defaultClassName + ' pagination__pages__page--active' : defaultClassName;
	      var disabled = currentPage == page ? true : false;
	      return _this.renderPage(page, _this.onClickPage.bind(_this, page, _this.update), className, disabled);
	    });
	  };
	  ...
	  this.render = function (_ref, element) {
	    ...
	    if (element) {
	      _this.tree = tree;
	      _this.node = (0, _createElement2.default)(_this.tree);
